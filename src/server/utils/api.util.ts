 ...
 */
type AsyncController<TSchema extends RequestValidationSchema, TRes = unknown> = (
 ...
 */
export type ApiHandler<TSchema extends RequestValidationSchema> = (
   req: ValidatedRequest<TSchema>,
   res: Response,
   next: NextFunction,
) => Promise<void>;
 ...
 */
export function createApiHandler<TSchema extends RequestValidationSchema, TRes = unknown>(
   fn: AsyncController<TSchema, TRes>,
): ApiHandler<TSchema> {
